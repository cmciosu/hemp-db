...
class CompanyTestCase(TestCase):
    def setUp(self):
        Company.objects.create(
            ...
            State="test",
            Country="test",
            Solutions=Solution.objects.get(id=1),
            Website="test",
            Category=Category.objects.get(id=1),
            stakeholderGroup=stakeholderGroup.objects.get(id=1),
            Stage=Stage.objects.get(id=1),
            productGroup=ProductGroup.objects.get(id=1),
            Products="test",
            sasContact="test",
            Description="test",
            pubPriv="test",
            ...
            Notes="test",
            salesRev="test",
            processingFocus=ProcessingFocus.objects.get(id=1),
            facilitySize="test",
            biomassCap="test",
            extractionType=ExtractionType.objects.get(id=1),
            GMP="test",
            news="test",
            reviews="test",
        )
